...
while True:
    ...
    for (top, right, bottom, left), face_encoding in zip(face_locations, face_encodings):
        ...
        matches = face_recognition.compare_faces(fdb.known_face_encodings, face_encoding, tolerance=0.52)
        ...
        face_distances = face_recognition.face_distance(fdb.known_face_encodings, face_encoding)
        best_match_index = np.argmin(face_distances)
        if matches[best_match_index]:
            name = fdb.known_face_names[best_match_index]
